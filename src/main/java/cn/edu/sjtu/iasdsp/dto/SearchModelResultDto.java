...
* Introduction
*/
public class SearchModelResultDto {

	private List<WorkflowInformation> workflowInformationList = new ArrayList<WorkflowInformation>(0);
	...
	public String toString() {
		return "SearchModelResultDto [workflowInformationList=" + workflowInformationList + "]";
	}
