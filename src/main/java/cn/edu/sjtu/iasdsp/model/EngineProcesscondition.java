 ...
 */
@Entity
@Table(name = "processcondition", catalog = "isdsp_dev")
public class EngineProcesscondition implements java.io.Serializable {
	...
	public EngineProcesscondition() {
	}

	public EngineProcesscondition(String processId, int conditionId) {
		this.processId = processId;
		this.conditionId = conditionId;
	}

	public EngineProcesscondition(String processId, int conditionId, String conditionRepresentation, String conditionName) {
		this.processId = processId;
		this.conditionId = conditionId;
