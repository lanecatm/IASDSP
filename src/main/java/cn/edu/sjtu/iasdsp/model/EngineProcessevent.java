...
public class EngineProcessevent implements java.io.Serializable {
	...
	public EngineProcessevent() {
	}

	public EngineProcessevent(String processId, int eventId) {
		this.processId = processId;
		this.eventId = eventId;
	}

	public EngineProcessevent(String processId, int eventId, String eventRepresentation, String expressionforParse,
