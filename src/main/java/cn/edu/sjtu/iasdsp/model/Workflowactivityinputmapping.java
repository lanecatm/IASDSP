...
public class Workflowactivityinputmapping implements java.io.Serializable {
	...
	public Workflowactivityinputmapping(int workflowId, int activityId, int dataflowId) {
		this.workflowId = workflowId;
		this.activityId = activityId;
		this.dataflowId = dataflowId;
	}

	public Workflowactivityinputmapping(int workflowId, int activityId, int dataflowId, String inputSchema,
