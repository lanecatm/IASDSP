...
public class Workflowflowobjectcontrol implements java.io.Serializable {
	...
	public Workflowflowobjectcontrol() {
	}

	public Workflowflowobjectcontrol(int workflowId, int flowId, short objectId) {
		this.workflowId = workflowId;
		this.flowId = flowId;
		this.objectId = objectId;
	}

	public Workflowflowobjectcontrol(int workflowId, int flowId, short objectId, Short privilege, Integer objectType) {
		this.workflowId = workflowId;
		this.flowId = flowId;
		this.objectId = objectId;
