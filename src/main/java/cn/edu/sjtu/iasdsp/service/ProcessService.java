...
public class ProcessService {
	...
	public String starAndShare(ShareExecuteDto shareExecuteDto) {
		...
		if(processInformation == null){
			throw(new NullPointerException("Can not find processInformation, id:" + shareExecuteDto.getProcessInformationId()));
		}
		// TODO change user
		User user = userHome.findById(UserType.DEFAULT_USER_ID);
	...
	private void createSharedProcess(ProcessInformation processInformation, User user, ShareExecuteDto shareExecuteDto) {
		...
		SharedProcessRecord sharedProcessRecord = new SharedProcessRecord(
				processInformation, wikiPage,
				workflowInformation, workflowVersion, 
				departmentInformation, 
				user, user,
				shareExecuteDto.getRunningCaseName(), 
