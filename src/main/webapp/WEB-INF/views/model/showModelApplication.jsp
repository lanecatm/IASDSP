...
<c:set var="i" value="1" />
<c:forEach items="${showModelDto.workflowInformation.wikiPages}" var="wikiPage">
	<div class="col-md-12">
 ...
 --%>						<td>${sharedProcessRecord.name}</td>
						...
						<td>
						   ...
						   <a class="btn btn-sm btn-danger" 
							   href="<c:url value="/execute/running_case/${sharedProcessRecord.id}/delete?model=${showModelDto.workflowInformation.id}"/>"> 
							   Delete </a>
						</td>
					</tr>
				</c:forEach>
