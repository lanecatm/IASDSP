...
<div class="col-md-12">
    ...
    <tr>
        <th rowspan="4">Basic information</th>
        <th> Model name</th>
        <td>
    	   ${showModelDto.title}
        </td>
    ...
    <tr>
        <th>Last editor</th>
        <td>
           ${showModelDto.lastEditor}
        </td>
    </tr>
    <tr>
        <th>Edit user group</th>
        <td>
           ${showModelDto.editUserGroup}
        </td>
    </tr>
    <tr>
        <th>Delete user group</th>
        <td>
           ${showModelDto.deleteUserGroup}
        </td>
    </tr>
    <tr>
        <th>Execute user group</th>
        <td>
           ${showModelDto.exectuteUserGroup}
        </td>
    </tr>
